  ...
  save(): void {
    ...
    if (this.editForm.valid) {
      if (curso.id !== undefined && curso.id !== null) {
        this.subscribeToSaveResponse(this.moduloService.update(cursoFicha));
      } else {
        this.subscribeToSaveResponse(this.moduloService.create(cursoFicha, this.selectedFiles[0]));
      }
    }
  }
