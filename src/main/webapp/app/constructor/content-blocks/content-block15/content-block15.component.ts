...
@Component({
  selector: 'jhi-content-block15',
  templateUrl: './content-block15.component.html',
  styleUrls: ['./content-block15.component.scss']
})
export class ContentBlock15Component implements AfterContentInit {
  ...
  orderTextActivity(components: IComponente[]): IComponente[] {
    let temp: IComponente[] = [];
    if (components.length > 1) {
      if (components[0].tipoComponente!.nombre === 'activity') {
