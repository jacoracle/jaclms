...
@Component({
  selector: 'jhi-content-block16',
  templateUrl: './content-block16.component.html',
  styleUrls: ['./content-block16.component.scss']
})
export class ContentBlock16Component implements AfterContentInit {
